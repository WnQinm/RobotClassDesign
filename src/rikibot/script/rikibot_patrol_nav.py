...
class PatrolNav():
    ...
    def __init__(self):
        ...
        self.locations = dict()
        self.locations['one']   = Pose(Point(9.186, 0.560, 0.000), Quaternion(0.000, 0.000, 0.999, -0.043))
        self.locations['two']   = Pose(Point(7.327, 0.526, 0.000), Quaternion(0.000, 0.000, 0.025,
 1.000))
        self.locations['three'] = Pose(Point(3.947, 0.415, 0.000), Quaternion(0.000, 0.000, 1.000, -0.025))
        self.locations['four']  = Pose(Point(0.541, 0.212, 0.000), Quaternion(0.000, 0.000, 0.025, 
1.000))
        self.locations['five']  = Pose(Point(7.107, 0.668, 0.000), Quaternion(0.000, 0.000, 1.000, -0.008))
        self.locations['six']   = Pose(Point(-0.521, 0.097, 0.000), Quaternion(0.000, 0.000, -0.020, 1.000))
