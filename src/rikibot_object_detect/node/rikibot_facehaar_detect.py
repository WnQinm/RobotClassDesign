...
class RikibotFaceHaarDetect():
    def __init__(self):
        rospy.init_node('rikibot_face_detect_node', log_level=rospy.INFO)
        ...
        dir_path = dir_path.replace('rikibot_object_detect/node', 'rikibot_object_detect/')
