...
class BoundingBox(genpy.Message):
  _md5sum = "a9496a94b88b437677445fb959969ac5"
...
string frame_id
"""
  __slots__ = ['header','image_header','probability','xmin','ymin','xmax','ymax','Class']
  _slot_types = ['std_msgs/Header','std_msgs/Header','float64','int64','int64','int64','int64','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,image_header,probability,xmin,ymin,xmax,ymax,Class
