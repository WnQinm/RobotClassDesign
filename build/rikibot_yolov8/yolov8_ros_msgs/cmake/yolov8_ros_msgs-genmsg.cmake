...
message(STATUS "yolov8_ros_msgs: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iyolov8_ros_msgs:/home/rikibot/robotCourseDesign2024/src/rikibot_yolov8/yolov8_ros_msgs/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/rikibot/robotCourseDesign2024/src/rikibot_yolov8/yolov8_ros_msgs/msg/BoundingBox.msg" NAME_WE)
add_custom_target(_yolov8_ros_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yolov8_ros_msgs" "/home/rikibot/robotCourseDesign2024/src/rikibot_yolov8/yolov8_ros_msgs/msg/BoundingBox.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(yolov8_ros_msgs
  "/home/rikibot/robotCourseDesign2024/src/rikibot_yolov8/yolov8_ros_msgs/msg/BoundingBox.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yolov8_ros_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yolov8_ros_msgs\")")
  # install generated code
  install(
